...
public class HereCommand implements SubCommand, CommandExecutor {
    private final LandManager landManager;
    private final ConfigManager config;

    public HereCommand(LandManager landManager, ConfigManager config) {
    ...
    public List<String> getAliases() {
        return List.of(new String[]{"info"});
    }
